...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="#">Manajemen Restoran</a></div>
            <div class="breadcrumb-item">Informasi Restoran</div>
        </div>
    </div>
    <div class="row">
        <form method="POST" action="{{ route('informasiRestoran.update', $d->id) }}" enctype="multipart/form-data" class="needs-validation" novalidate="" style="width: 100%;display: flex;flex-wrap:wrap;">
            @csrf
            {{ method_field('PUT') }}
            <div class="col-12 col-lg-4">
                <div class="card card-primary">
                    <div class="card-header">
                        <h4>Gambar / Logo Restoran</h4>
                    </div>
                    <div class="card-body foto-upload">
                        <div class="form-group">
                            <div class="col-sm-12">
                                @if(!empty($d->foto))
                                <div id="image-preview" class="image-preview" style="background: url('{{ asset('img_upload/restoran/'.$d->foto) }}'); background-size: cover; background-repeat: no-repeat;">
                            ...
                            <div class="col-12 col-lg-8">
                                <div class="form-group">
                                    ...
                                    <div class="invalid-feedback">
                                        Form Nama Restoran harus diisi!
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-lg-4">
